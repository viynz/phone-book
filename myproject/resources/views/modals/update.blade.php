...
<!-- Modal Update User -->
    <div class="modal fade" id="UpdateContactsModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xs">
                <div class="modal-content">

<form class="update-form" method="POST" id="updateContactForm" action="/contact/UpdateContact" enctype="multipart/form-data">
        ...
        {{ csrf_field() }}
                    ...
                    <div class="modal-header">
                        <div class="col-md-6">
                            <div class="pull-center">Update Contact</div>
                        </div>
                        <div class="col-md-6">
